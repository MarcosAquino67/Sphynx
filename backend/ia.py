...
SYSTEM_ES = (
    ...
    "FORMATO DE FÓRMULAS (obligatorio): escribilas en UNA sola línea simple, "
    "ejemplo 'Fórmula: F = m · a' o 'v = ω · R'. PROHIBIDO usar $$, bloques de "
    "código, \\\\frac, \\\\cdot u otros comandos LaTeX. Para potencias usá ^ "
    "(ej x^2) y para subíndices _ (ej T_0). Negritas solo con **palabra**. "
...
SYSTEM_JOPARA = (
    ...
    "FORMATO FÓRMULA (obligatorio): peteĩ línea simple añoite, ejemplo "
    "'Fórmula: F = m · a' térã 'v = ω · R'. PROHIBIDO $$, código, \\\\frac, "
    "\\\\cdot ha LaTeX comando. Potencia ^ reheve (x^2), subíndice _ reheve "
    "(T_0). Negrita **ñe'ẽ** añoite reheve. "
